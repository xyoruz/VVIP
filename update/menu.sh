#!/bin/bash
# =========================================
BOT="https://raw.githubusercontent.com/xyoruz/scriptvpn/main/bot.sh"
UPDATE="https://raw.githubusercontent.com/xyoruz/VVIP/ipuk/update/update.sh"
GREEN='\033[0;32m'
RED='\033[0;31m'
ipsaya=$(wget -qO- ipinfo.io/ip)
data_server=$(curl -v --insecure --silent https://google.com/ 2>&1 | grep Date | sed -e 's/< Date: //')
date_list=$(date +"%Y-%m-%d" -d "$data_server")
data_ip="https://raw.githubusercontent.com/xyoruz/izinvps/ipuk/ip"
checking_sc() {
...
Exp=$(curl -sS https://raw.githubusercontent.com/xyoruz/izinvps/ipuk/ip | grep $MYIP | awk '{print $3}')
fi
...
echo -e "  ${BLUE}• ${GREEN}Developer           ${NC}= XYR-VPN Tunneling ${NC}"
echo -e "$COLOR1┌────────────────────────────────────────────────────────────┐${NC}"
